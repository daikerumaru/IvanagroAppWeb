...
header("Content-Disposition: attachment; filename=A18V1.csv");
  ...
  <br>
    ...
    <tbody>
       ...
       <?php 
        ...
        $query = "SELECT * FROM a18v1 where beneficiario={$filtro_beneficiario}";
        ...
        echo "<td><a href='main.php?edit=a18v1&numero={$beneficiario}&actividad_editar={$actividad}'>Editar</a></td>";
