<?php
 ...
 if(isset($_GET['numero'])){
        ...
        $query = "SELECT * FROM a20v2 where beneficiario={$numero}";
...
$query .= "WHERE beneficiario = '{$beneficiario}' ";
    ...
    echo "<p class='bg-success'>Mipyme actualizada correctamente.<a href='./main.php?actividad=A20V2'> Volver </a>";
