...
header("Content-Disposition: attachment; filename=A16V1.csv");
...
<div>
    ...
    <tbody>
       ...
       <?php 
        ...
        $query = "SELECT * FROM a16v1 where beneficiario={$filtro_beneficiario}";
        ...
        echo "<td><a href='main.php?edit=a16v1&numero={$beneficiario}&actividad_editar={$actividad}'>Editar</a></td>";
