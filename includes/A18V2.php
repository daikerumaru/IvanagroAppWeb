...
header("Content-Disposition: attachment; filename=A18V2.csv");
  ...
  <br>
    ...
    <tbody>
       ...
       <?php 
        ...
        $query = "SELECT * FROM a18v2 where beneficiario={$filtro_beneficiario}";
        ...
        echo "<td><a href='main.php?edit=a18v2&numero={$beneficiario}&actividad_editar={$actividad}'>Editar</a></td>";
