<?php
 ...
 if(isset($_GET['numero'])){
        ...
        $query = "SELECT * FROM a24v1 where beneficiario={$numero}";
...
$query .= "WHERE beneficiario = '{$beneficiario}' ";
    ...
    echo "<p class='bg-success'>Mipyme actualizada correctamente.<a href='./main.php?actividad=A24V1'> Volver </a>";
