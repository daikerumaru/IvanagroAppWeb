<?php
 ...
 if(isset($_GET['numero'])){
        ...
        $query = "SELECT * FROM a18v2 where beneficiario={$numero}";
...
$query .= "WHERE beneficiario = '{$beneficiario}' ";
    ...
    echo "<p class='bg-success'>Mipyme actualizada correctamente.<a href='./main.php?actividad=A18V2'> Volver </a>";
