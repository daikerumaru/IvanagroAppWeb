...
header("Content-Disposition: attachment; filename=A24V1.csv");
  ...
  <br>
    ...
    <tbody>
       ...
       <?php 
        ...
        $query = "SELECT * FROM a24v1 where beneficiario={$filtro_beneficiario}";
        ...
        echo "<td><a href='main.php?edit=a24v1&numero={$beneficiario}&actividad_editar={$actividad}'>Editar</a></td>";
