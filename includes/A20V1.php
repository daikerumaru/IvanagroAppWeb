...
header("Content-Disposition: attachment; filename=A20V1.csv");
  ...
  <br>
    ...
    <tbody>
       ...
       <?php 
        ...
        $query = "SELECT * FROM a20v1 where beneficiario={$filtro_beneficiario}";
        ...
        echo "<td><a href='main.php?edit=a20v1&numero={$beneficiario}&actividad_editar={$actividad}'>Editar</a></td>";
