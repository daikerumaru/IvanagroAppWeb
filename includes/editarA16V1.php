<?php
 ...
 if(isset($_GET['numero'])){
        ...
        $query = "SELECT * FROM a16v1 where beneficiario={$numero}";
...
$query .= "WHERE beneficiario = '{$beneficiario}' ";
    ...
    echo "<p class='bg-success'>Mipyme actualizada correctamente.<a href='./main.php?actividad=A16V1'> Volver </a>";
