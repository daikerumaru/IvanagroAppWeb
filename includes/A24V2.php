...
header("Content-Disposition: attachment; filename=A24V2.csv");
  ...
  <br>
    ...
    <tbody>
       ...
       <?php 
        ...
        $query = "SELECT * FROM a24v2 where beneficiario={$filtro_beneficiario}";
        ...
        echo "<td><a href='main.php?edit=a24v2&numero={$beneficiario}&actividad_editar={$actividad}'>Editar</a></td>";
